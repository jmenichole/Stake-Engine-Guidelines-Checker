        ...
        <div>
            <div className="mb-8">
                ...
                <p className="text-lg text-gray-400">
                    Upload your game's HTML file to get an AI-powered compliance analysis against Stake Engine guidelines.
                </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6 shadow-lg mb-6">
                    ...
                    <div className="space-y-1 text-center">
                        ...
                        <div className="flex text-sm text-gray-500">
                            <label htmlFor="file-upload" className="relative cursor-pointer bg-gray-800 rounded-md font-medium text-cyan-400 hover:text-cyan-300 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-900 focus-within:ring-cyan-500">
                                ...
                                <input id="file-upload" name="file-upload" type="file" className="sr-only" onChange={handleFileChange} accept=".html,.htm" />
                            </label>
                        </div>
                ...
                {fileName && <p className="text-center mt-4 text-gray-300">File loaded: <strong>{fileName}</strong></p>}
